...
/**
 * max_heap - Binary tree to a complete binary heap.
 * @array: Array of integers illustrating a binary tree.
...
/**
 * heap_sort - Using the heap sort algorithm to sort
...
void heap_sort(int *array, size_t size)
{
	...
	for (a = (size / 2) - 1; a >= 0; a--)
		max_heap(array, size, size, a);

	for (a = size - 1; a > 0; a--)
	{
		swap_ints(array, array + a);
		print_array(array, size);
		max_heap(array, size, a, 0);
	}
}
